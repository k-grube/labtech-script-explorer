...
class EditorView extends Component {
  ...
  render() {
    ...
    const panes = [{
      menuItem: 'Script XML',
      render: () => <Tab.Pane><EditorXML/></Tab.Pane>,
    }, {
      menuItem: 'Script JSON',
      render: () => <Tab.Pane><EditorJSON/></Tab.Pane>,
    }, {
      menuItem: 'Script View',
      render: () => <Tab.Pane><EditorScript/></Tab.Pane>,
    }];
...
export default connect(
  (state) => ({activeIndex: state.script.activeIndex, LabTechScript: state.script.LabTechScript}),
  {changeTab},
)(EditorView);
